...
@Component({
  ...
  template: `
    <section class="page-hero">
      <div class="container">
        <div class="breadcrumb"><a routerLink="/">Home</a> / <a routerLink="/courses">Courses</a> / CCA</div>
        <div class="hero-content">
          <div class="course-badge-big">📜</div>
          <h1>CCA</h1>
          <p>Certificate in Computer Applications</p>
          <div class="meta-chips">
            <span>⏱ 3 Months</span><span>📋 8th Pass</span><span>💰 ₹3,000</span><span>🏆 Certified</span>
          </div>
        ...
        <div class="detail-grid">
          <div class="main-content">
            <div class="section-block">
              ...
              <p>The Certificate in Computer Applications (CCA) is a 3-month introductory course designed for absolute beginners. It provides a solid foundation in computer usage, MS Office tools, and internet communication. Perfect for homemakers, shopkeepers, students, and working professionals who want to become digitally literate quickly and affordably.</p>
            </div>
            <div class="section-block">
              <h2>📚 Syllabus</h2>
          ...
          <div class="sidebar">
            <div class="enroll-card">
              ...
              <div class="info-rows">
                ...
                <div class="info-row"><span>Batch Size</span><span>Small (15 max)</span></div>
              </div>
  ...
  `,
  styles: [`
    .page-hero { background: linear-gradient(135deg, #00bcd4, #0097a7); padding: 120px 0 60px; }
    .container { max-width: 1200px; margin: 0 auto; padding: 0 20px; }
    .breadcrumb { color: rgba(255,255,255,0.6); font-size: 14px; margin-bottom: 24px; }
    .breadcrumb a { color: #b2ebf2; text-decoration: none; }
    ...
    .btn-enroll { display: inline-block; background: white; color: #0097a7; padding: 14px 36px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 16px; }
    ...
    .syllabus-item { display: flex; align-items: center; gap: 12px; background: #e0f7fa; border-radius: 8px; padding: 12px 16px; }
    .syl-num { width: 28px; height: 28px; background: #00bcd4; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 13px; flex-shrink: 0; }
    ...
    .check { color: #00bcd4; font-weight: 700; font-size: 16px; }
    ...
    .btn-enroll-full { display: block; background: linear-gradient(135deg, #00bcd4, #0097a7); color: white; padding: 14px; border-radius: 8px; text-decoration: none; font-weight: 600; text-align: center; margin-bottom: 12px; }
    .btn-call { display: block; border: 2px solid #00bcd4; color: #00bcd4; padding: 12px; border-radius: 8px; text-decoration: none; font-weight: 600; text-align: center; }
    @media (max-width: 900px) { .detail-grid { grid-template-columns: 1fr; } }
    @media (max-width: 600px) { .syllabus-grid { grid-template-columns: 1fr; } }
  `]
})
export class CcaComponent {
  syllabus = ['Computer Basics & Hardware', 'Windows Operating System', 'MS Word – Typing & Documents', 'MS Excel – Basic Spreadsheets', 'Internet & Email', 'Digital Payments & e-Governance'];
  outcomes = ['Office Helper', 'Shop Billing Assistant', 'Basic Data Entry', 'Digital Literacy Certified Professional'];
}
